---
name: vibe-clarify
description: 需求工作流阶段 1 — 自建需求骨架、起草给人读的 requirement.md、用 grill-with-docs 逐个澄清、产出给 AI 执行的 blueprint.md 与 open-questions.md。单应用需求直接启动;跨应用需求由 cross-app-spec 生成的启动指令带入。Use when the user says "需求澄清", "建需求 spec", "vibe-clarify", "起草需求", or pastes a cross-app-spec 启动指令 containing /vibe-clarify.
---
